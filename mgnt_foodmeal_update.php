...
if(!empty($_SESSION['session_user'])){
    $sql_update = "update food_meal set meal_name = '".$_REQUEST['food_mead']."', meal_type = '".$_REQUEST['meal_type']."', 
                                        meal_notice = '".$_REQUEST['food_notice']."', 
                                        meal_modify_by = '".$_SESSION['session_user']."', 
                                        meal_modify_datetime = '".date('Y-m-d H:i:s')."' where meal_id = '".$_REQUEST['item_id']."'";
