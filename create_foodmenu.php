...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_foodmenu_add.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Create Food Menu</h2>
                            <div class="clearfix"></div>
                        </div>
    ...
    ?>
                            ...
                            <hr>
                            <div class="form-group row">
                                <h4 class="text-success">สารอาหาร ทั้งหมด</h4>
                            </div>
                            <!-- สารอาหาร -->
                            <div class="form-group row">
                                <?
    ...
    for($n=0;$n<count($nutrient);$n++){ ?>
                                <div class="col-lg-2 col-md-3 form-group has-feedback">
                                    <input class="form-control has-feedback-left" type="number" id="<?=$nutrient[$n]?>" name="<?=$nutrient[$n]?>" value="<?=$reault_modify[$nutrient[$n]]?>">
                            ...
                            <hr>
                            <div class="form-group row">
                                <h4 class="text-warning">แหล่งอ้างอิง ข้อมูล</h4>
                            </div>
    ...
    ?>
                                    <select class="form-control" id="reference_wt" name="reference_wt" required>
                                        ...
                                        <option value="<?=$result_food_wt[$fwt]['ref_code']?>"><?=$result_food_wt[$fwt]['reference']?></option>
                                        <? } ?>
                                    </select>
                                </div>
                            </div>
    ...
    ?>
                                    <select class="form-control" id="reference_food" name="reference_food" required>
                                        ...
                                        <option value="<?=$result_food_fd[$rfd]['ref_code']?>"><?=$result_food_fd[$rfd]['reference']?></option>
                                        <? } ?>
                                    </select>
                                </div>
                            </div>
    ...
    ?>
                                    <select class="form-control" id="reference_fm" name="reference_fm">
                                        <option value="">...</option>
                                        <? for($rfm=0;$rfm<$nr_food_fm;$rfm++){ ?>
                                        <option value="<?=$result_food_fm[$rfm]['ref_code']?>"><?=$result_food_fm[$rfm]['reference']?></option>
                                        <? } ?>
                                    </select>
                                </div>
                            </div> 
