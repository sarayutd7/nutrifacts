<?
$sql_modify = "select * from reference_fm where ref_code = '".$_GET['item']."'";
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Modify Reference Food Menu</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_reference_fm_update.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Edit Reference Food Menu - <?=$reault_modify['reference']?></h2>
                            <div class="clearfix"></div>
                        </div>
