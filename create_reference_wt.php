    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Create Reference น้ำหนักและปริมาณในอาหาร</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_reference_wt_add.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Edit Reference น้ำหนักและปริมาณในอาหาร</h2>
                            <div class="clearfix"></div>
                        </div>
