    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_foodtype_add.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Food - ประเภทอาหาร</h2>
                            <div class="clearfix"></div>
                        </div>
                        <input type="hidden" id="item_id" name="item_id" value="<?=$reault_modify['type_code']?>">
                        <input type="hidden" id="type_type" name="type_type" value="2">
                        <div class="x_content">
