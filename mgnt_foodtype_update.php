...
if(!empty($_SESSION['session_user'])){
    $sql_update = "update food_type set type_name = '".$_REQUEST['food_type']."', type_type = '".$_REQUEST['type_type']."', 
                                        type_notice = '".$_REQUEST['type_notice']."', 
                                        type_modify_by = '".$_SESSION['session_user']."', 
                                        type_modity_datetime = '".date('Y-m-d H:i:s')."' where type_code = '".$_REQUEST['item_id']."'";
