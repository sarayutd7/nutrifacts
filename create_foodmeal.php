    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_foodmeal_add.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Food Mead - มื้ออาหาร</h2>
                            <div class="clearfix"></div>
                        </div>
                        <input type="hidden" id="item_id" name="item_id" value="<?=$reault_modify['meal_id']?>">
                        <input type="hidden" id="meal_type" name="meal_type" value="2">
                        <div class="x_content">
                            <div class="form-group row">
                                <div class="col-lg-1 col-lg-offset-4 col-sm-1"><span>มื้ออาหาร</span></div>
