<?
$sql_modify = "select * from reference_fd where ref_code = '".$_GET['item']."'";
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form action="mgnt_reference_food_update.php" method="post" enctype="application/x-www-form-urlencoded">
                        <div class="x_title">
                            <h2>Form Edit Reference Food - <?=$reault_modify['reference']?></h2>
                            <div class="clearfix"></div>
                        </div>
